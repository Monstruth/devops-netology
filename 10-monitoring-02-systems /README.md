...
Что бы проще понимать собираемые метрики и отображать собираемые данные в удобном виде можно воспользоваться , например, таким инструментом для визуализации, мониторинга и анализа данных как Grafana или подобные. При просмотре графиков будет понятнее как работает система. Так же можно настроить различные алерты, чтобы менеджеру не думать как там и что работает, при критических ошибках система мониторинга будет сама присылать предупреждения.
